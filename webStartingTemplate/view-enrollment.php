			...
			<div class="row">
				...
				<div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
							<ul class="list-group">
								<li class="list-group-item">gender: <span class="float-right badge badge-primary"><?php echo $fullname?></span></li>
								<li class="list-group-item">courses: <span class="float-right badge badge-secondary"><?php echo $email?></span></li>
								<li class="list-group-item">phone number: <span class="float-right badge badge-danger"><?php echo $phonenumber?></span></li>
